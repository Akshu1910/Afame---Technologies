...
Original file is located at
    https://colab.research.google.com/drive/1fxIdaP4KtQREmrbBCabTVEi7HAlyLJlL
...
movie_data = pd.read_csv('/content/Movie dataset.csv', encoding='latin1')
...
"""#### Distribution of top 10 movies (according to the year)"""
...
"""#### Top Directors by average rating distribution"""
...
"""#### The number of votes and movie ratings relationship"""
...
"""#### Top actors by movie count distribution"""
...
"""#### The number of movies released every year distribution"""
...
# Convert 'Rating' to string to avoid AttributeError in legend handling
...
"""#### Duration of movies by the years distribution"""
...
"""#### The number of movies for each genre distribution"""
...
"""#### Average rating of movies in each genre distribution"""
...
"""#### Examining correlation of data"""

# correlation
corr_df = trans_data.corr(numeric_only=True)
corr_df['Rating'].sort_values(ascending=False)

corr_df = movie_data.corr(numeric_only=True)  # Generates correlation matrix for numeric columns
sns.heatmap(corr_df, annot=False, cmap="coolwarm")
plt.show()  # Recommended to display the plot in Colab
